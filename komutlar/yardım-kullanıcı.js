...
module.exports.run = async (client, message, args) => {
 let botid = "691764976385523804"
    const embed = new Discord.RichEmbed()
        ...
        .addField(`**<a:elmas1:679038564994121744>__SELAMPAK KULLANICI KOMUTLAR__<a:elmas1:679038564994121744>**`,`▬▬▬▬▬▬▬▬▬▬▬▬๑۩۞۩๑▬▬▬▬▬▬▬▬▬▬▬▬\n \`\`instagram\`\` , \`\`adamasmaca\`\` , \`\`wasted\`\` , \`\`pixel\`\` , \`\`zar-at\`\` , \`\`zıt-renk\`\` , \`\`sunucuresmi\`\` , \`\`avatar\`\` , \`\`slots\`\` , \`\`rip\`\` , \`\`profil\`\` , \`\`piyango\`\` , \`\`nsfw\`\` , \`\`nsfw-4k\`\` , \`\`missonpassed\`\` , \`\`steam-fiyat\`\` , \`\`kapaklaflar\`\` , \`\`kanalbilgi\`\` , \`\`kafadansı\`\` , \`\`kaccm\`\` , \`\`istatistik\`\` , \`\`hapis\`\` , \`\`espri\`\` , \`\`efkarım\`\` , \`\`aşkölçer\`\` , \`\`fal\`\` , \`\`düello\`\` , \`\`kartopu\`\` , \`\`kahve\`\` , \`\`ağla\`\` , \`\`duygulandırıcı-sözler\`\` , \`\`stresçarkı\`\` , \`\`herkesebendençay\`\` , \`\`ara155\`\` , \`\`casper\`\` , \`\`youtube\`\` , \`\`rolbilgi\`\` , \`\`ass\`\` , \`\`vine\`\` , \`\`sunucular\`\` , \`\`clyde\`\` , \`\`komutlar\`\` , \`\`ping\`\` , \`\`neko\`\` , \`\`taksimdayı\`\` , \`\`sor\`\` , \`\`tersyaz\`\` , \`\`koş\`\` , \`\`film-ara\`\` , \`\`8ball\`\` , \`\`gif\`\` , \`\`spotify\`\` , \`\`mcödül\`\` , \`\`yapımcım\`\` , \`\`alivefa-ol\`\` , \`\`elyazı\`\` , \`\`twitter\`\` , \`\`:D\`\` , \`\`banner\`\` , \`\`sunucubilgi\`\` , \`\`gta\`\` , \`\`zula-deste-aç\`\` , \`\`boks-makinesi\`\` \n ▬▬▬▬▬▬▬▬▬▬▬▬๑۩۞۩๑▬▬▬▬▬▬▬▬▬▬▬▬`)    
