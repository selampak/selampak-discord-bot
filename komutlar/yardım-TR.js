...
module.exports.run = async (client, message, args) => {
 let botid = "546323875068379137"
    const embed = new Discord.RichEmbed()
        ...
        .addField(`**<a:elmas1:679038564994121744>__SELAMPAK KOMUTLAR__<a:elmas1:679038564994121744>**`,`▬▬▬▬▬▬▬▬▬▬▬▬๑۩۞۩๑▬▬▬▬▬▬▬▬▬▬▬▬\n◼  ** *kullanıcı** - Kullanıcı Komutları. \n◼  ** *admin** - Yetkili Komutları \n◼  ** *müzik-yardım** - Müzik Komutları \n◼  ** *bot** - Bot Hakkında\n◼  ** *gold-üye** - Gold üye fiyatları \n◼  ** *yenilikler** - Bot Yenilikler\n ▬▬▬▬▬▬▬▬▬▬▬▬๑۩۞۩๑▬▬▬▬▬▬▬▬▬▬▬▬`)
